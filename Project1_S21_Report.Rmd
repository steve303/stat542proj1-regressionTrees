...
# Results
In general, for each split the GBM model has a lower RMSE than the ElasticNet model.  The underlying data may not be best described as a linear regression model since the GBM model seems to be doing a better job.  We were able to achieve the set performance goals for each model.
