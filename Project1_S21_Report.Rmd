---
title: "Predict the Housing Prices in Ames, Iowa - Decision Tree (GBM) vs Regression Model (Elastic Net)"
date: "Fall 2021"
output:
  html_notebook:
    theme: readable
...
# Results
In general, for each split the GBM model has a lower RMSE than the ElasticNet model.  The underlying data may not be best described as linear since the GBM model seems to be doing a better job.  We were able to achieve the set performance goals for each model.
